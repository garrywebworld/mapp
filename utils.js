...
const TEXTURE_BASE = "https://cdn.jsdelivr.net/gh/Izaacapp/threejs-earth@main/textures/";
const TEXTURES = {
  map: `${TEXTURE_BASE}00_earthmap1k.jpg`,
  bump: `${TEXTURE_BASE}01_earthbump1k.jpg`,
  specular: `${TEXTURE_BASE}02_earthspec1k.jpg`,
  lights: `${TEXTURE_BASE}03_earthlights1k.jpg`,
  clouds: `${TEXTURE_BASE}04_earthcloudmap.jpg`
};
...
export class GlobeExplorer {
  ...
  initThree() {
    ...
    const bumpMap = loader.load(TEXTURES.bump);
    const specularMap = loader.load(TEXTURES.specular);
    const lightsMap = loader.load(TEXTURES.lights);
    const cloudsMap = loader.load(TEXTURES.clouds);
    ...
    const earthMaterial = new THREE.MeshPhongMaterial({
      ...
      bumpScale: 0.045,
      specularMap,
      specular: new THREE.Color(0x4d7fa8),
      shininess: 14,
      emissiveMap: lightsMap,
      emissive: new THREE.Color(0xffdfa0),
    ...
    this.scene.add(new THREE.AmbientLight(0x8bbdff, 0.45));
    const sun = new THREE.DirectionalLight(0xffffff, 1.7);
    sun.position.set(5, 3, 4);
    this.scene.add(sun);
    const night = new THREE.DirectionalLight(0x0b46a1, 0.35);
